...
function adapter_match_pe(adapter1_seqheadset::SeqHeadSet, adapter2_seqheadset::SeqHeadSet,
                            r1::FqRecord, r2::FqRecord, init_seq_rc::Bool,
                            r1_seq_rc_threads::Vector{LongDNA{4}}, r2_seq_rc_threads::Vector{LongDNA{4}}, op::PEOptions)
