...
> Ktrim throwed an error when processing simulated fastq files. It is accuracy was benched using other methods in the preprint of [Atria paper](https://www.biorxiv.org/content/10.1101/2021.09.07.459340). 
